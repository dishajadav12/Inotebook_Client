...
const Why = () => {
  ...
  return (
    ...
    <div className="why-content-2  my-3">
      <div className="why-sub-content" style={{backgroundColor:"rgba(244, 196, 187,0.6)"}}>
        <div className="sub-content-title"> Seamless Note-Taking</div>
        <div className="sub-content-info"> Our digital notebook offers a seamless note-taking
      ...
      <div className="why-sub-content" style={{backgroundColor:"rgba(221, 160, 149,0.7)"}}>
        <div className="sub-content-title">Easy Modification</div>
         <div className="sub-content-info"> We understand that ideas evolve and thoughts change.
      ...
      <div className="sub-content-title">User-Friendly Interface</div> 
      <div className="sub-content-info">Our user-friendly interface is designed to cater to all
...
<div className="why-content-2  my-3">
        ...
        <div className="why-sub-content "style={{backgroundColor:"rgba(198, 124, 111,0.4)"}}>     
          <div className="sub-content-title"> Multi-Platform Access</div> 
          <div className="sub-content-info">Access your digital notebook anytime, anywhere,
      ...
      <div className="why-sub-content" style={{backgroundColor:"rgba(250, 217, 209)"}}>
       ...
       <div className="sub-content-info"> We take your data security seriously.
        ...
        <div className="sub-content-info">Share your notes

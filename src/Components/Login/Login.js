    ...
    <CSSTransition in={true} appear={true} timeout={2000} classNames="slide">
      <div className="container log-sign-container">
        ...
        <div className="login-container mt-2">
          <div className="text-center-mob" style={{ color: "#555" }}>
            Collect Your Thoughts.
          </div>

          <h2 className="my-2">
            Login to continue to i<span className="span-navbar-brand">N</span>
            otebook
          </h2>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="btn login-btn-form my-3">
              Login
            </button>
          </form>
        ...
        <div className="design-container">
          ...
          <div className="text-center-2" style={{ color: "#555" }}>
            Unlock the art of hassle-free note-taking, all for free!
          </div>
        </div>
      </div>
    </CSSTransition>
